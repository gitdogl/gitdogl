...
//public class class_20230207112412  extends ToolUtil {
...
//                String eventid=Util.null2String(cmap.get("eventid"));
...
//                    }
//                }
//                jsonobj.put("requesstid",requestId);//流程
//                jsonobj.put("eventid",eventid);//回写表
//                jsonobj.put("mainkeyid",mainkeyid);//主表ID
//                //明细序列
...
//                        this.writeNewDebuggerLog(className,com_debit_obj);
//                        if(com_debit_obj!=null&&!"".equals(Util.null2String( com_debit_obj.get("FACCOUNTID")))&&(Util.getDoubleValue( Util.null2String(com_debit_obj.get("FDEBIT")),0)!=0 ||Util.getDoubleValue( Util.null2String(com_debit_obj.get("FCREDIT")),0)!=0)) {
...
//                            if(tax_debit_obj!=null&&!"".equals(Util.null2String( tax_debit_obj.get("FACCOUNTID")))&&(Util.getDoubleValue( Util.null2String(tax_debit_obj.get("FDEBIT")),0)!=0 ||Util.getDoubleValue( Util.null2String(tax_debit_obj.get("FCREDIT")),0)!=0)) {
...
//                            if(cx_loan_obj!=null&&!"".equals(Util.null2String( cx_loan_obj.get("FACCOUNTID")))&&(Util.getDoubleValue( Util.null2String(cx_loan_obj.get("FDEBIT")),0)!=0 ||Util.getDoubleValue( Util.null2String(cx_loan_obj.get("FCREDIT")),0)!=0)) {
...
//                            if(zz_debit_obj!=null&&!"".equals(Util.null2String( zz_debit_obj.get("FACCOUNTID")))&&(Util.getDoubleValue( Util.null2String(zz_debit_obj.get("FDEBIT")),0)!=0 ||Util.getDoubleValue( Util.null2String(zz_debit_obj.get("FCREDIT")),0)!=0)) {
...
//                            if(zz_loan_obj!=null&&!"".equals(Util.null2String( zz_loan_obj.get("FACCOUNTID")))&&(Util.getDoubleValue( Util.null2String(zz_loan_obj.get("FDEBIT")),0)!=0 ||Util.getDoubleValue( Util.null2String(zz_loan_obj.get("FCREDIT")),0)!=0)) {
...
//                                    detailArray.add(com_debit_obj);
//                                    this.writeNewDebuggerLog(className, "com_debit_obj:[" + com_debit_obj.toJSONString() + "]");
//
//                                    if(tax_debit_list != null && tax_debit_list.size() > 0){
//                                        JSONObject tax_debit_obj = vu.genarate_json(baseArray, tax_debit_list, rs, rs_detail,1,dtTableName,rowIndex++);
//                                        if(tax_debit_obj!=null&&!"".equals(Util.null2String( tax_debit_obj.get("FACCOUNTID")))&&(Util.getDoubleValue( Util.null2String(tax_debit_obj.get("FDEBIT")),0)!=0 ||Util.getDoubleValue( Util.null2String(tax_debit_obj.get("FCREDIT")),0)!=0)) {
//                                            detailArray.add(tax_debit_obj);
//                                            //   this.writeNewDebuggerLog(className, "tax_debit_obj:[" + tax_debit_obj.toJSONString() + "]");
//                                        }
//                                    }
//
//                                    //冲销贷方字段配置集合
...
//                    if(com_loan_obj!=null) {
//                        detailArray.add(com_loan_obj);
//                    }
//
//                    jsonobj.put("toDetail", detailArray);
//
//                    this.writeNewDebuggerLog(className, "Send JSON Data:" + Util.null2String(jsonobj));
//
//                    //待发送的JSON字符串
//                    vlog.setSenddata(Util.null2String(jsonobj));
//
//
//                    // vlog.setResult(1);
//
...
//                    JSONObject resultobj = vu.sendPost_New(jsonobj);
//
//                    if (resultobj != null) {
//                        this.writeNewDebuggerLog(className, "Receive JSON Data:" + Util.null2String(resultobj));
//
//                        vlog.setReceivedata(Util.null2String(resultobj));
//
//                        if ("0".equals(resultobj.get("code"))) {//说明成功
//                            vlog.setResult(1);
//
//                            cansubmit = true;
//
//                            message = Util.null2String(resultobj.get("msg"));
//                            vlog.setMessage(message);
//
//                        } else {//说明失败
//                            vlog.setResult(2);
...
//            this.writeNewDebuggerLog(className, cansubmit+"------------------" + className + " END-----------------");
//
//            if(!cansubmit)
//            {
//                ret.put("code", "0");
...
//
//        String select_sql = "select uuid,paramvalue from uf_dpx_config";
//
//        RecordSet rs = new RecordSet();
//
//        if(!"".equals(likestr)){
...
//
//        if(!"".equals(uuid)){
//            String select_sql = "select paramvalue from uf_dpx_config where uuid = '" + uuid + "'";
//
//            RecordSet rs = new RecordSet();
...
//        String endValue = "";
//        this.writeLog("原始SQL:[" + cus_sql + "]detailKeyvalue"+detailKeyvalue+"requestid"+requestid);
//        cus_sql = cus_sql.replace("&nbsp;", " ");
//
...
//
//        if(rs.executeQuery(sqlString)){
//            this.writeLog("执行结果:[" + endValue+ "]");
//            rs.next();
//            this.writeLog("执行的转换后的SQL查询到的原始值:[" + Util.null2String(rs.getString(1)) + "]");
//            endValue = Util.null2String(rs.getString(1));
//            this.writeLog("执返回结果:[" + endValue + "]");
//        }
//
//        return endValue;
//    }
...
//
//
//            String folder = GCONST.getRootPath() + "log" + File.separatorChar + "dpx";
//
...
//    //凭证日志表名称
//    private static String VoucherLogger_Mode_Table = "uf_dpxvoucher_log";
//
//    //凭证日志建模模块ID
...
//
//        String select_main = "select * from uf_dpx_voucher where wfid in (" + allwfid + ")";
//
//        if(!"".equals(cusparam)){
...
//            //for(int k = 1; k <= 2 ;k++){
//            //查询明细数据
//            String select_detail = "select dt.*,wb.fieldname,wb.viewtype,wb.detailtable from uf_dpx_voucher_dt1 dt " +
...
//            }
//
//            if(prettysend.length()>1000)
//            {
//                //prettysend=prettysend.substring(0,1000)+"...";
//            }
//            if(prettyreceive.length()>1000)
//            {
//                // prettyreceive=prettyreceive.substring(0,1000)+"...";
//            }
//            String message=logger.getMessage().replace("'","''").replace("?","");
//            if(message.length()>988)
//            {
//                // message=message.substring(0,988)+"...";
//            }
...
//        this.writeDebuggerLog(className, "开始生成jsonObject==" +datalist.toArray().toString() + "]index"+index);
//
...
//                }
//
//                if("ItemText".equals(jsonname))
//                {
//                    this.writeDebuggerLog(className, "ItemText==" + fieldvalue + "]detailmap"+detailmap.toString());
//                }
//
//
//                switch (changerule){
...
//                        }
//
//                        fieldvalue = getValueByChangeRule(cussql,fieldvalue,baseArray[0],detailkeyid);
//                        if("ItemText".equals(jsonname))
//                        {
//                            this.writeDebuggerLog(className, "ItemText==最后" + fieldvalue + "detailkeyid"+detailkeyid+"]cussql"+cussql);
//
//                        }
//                        break;
//                    default://不转换
...
//                if("ItemText".equals(jsonname))
//                {
//                    this.writeDebuggerLog(className, "ItemText==最后" + fieldvalue + "]changerule"+changerule);
//
//                }
...
//        }
//
//        this.writeDebuggerLog(className, " 处理结束jsonObject==" + jsonObject.toJSONString() + "]");
//
//        return jsonObject;
//    }
//
...
//     * @return
//     */
//    public JSONObject sendPost_New(JSONObject jsonobj){
//        JSONObject resultobj = new  JSONObject();
//        try {
//
//            //是否删除历史明细0保留1删除
//            String del_Detail = this.getSystemParamValue("Del_Detail");
//          /*  jsonobj.put("requesstid",requestId);//流程
//            jsonobj.put("eventid",eventid);//回写表
//            jsonobj.put("mainkeyid",mainkeyid);//主表ID
//            jsonobj.put("toDetail", detailArray);
//            *
//           */
//            String requestId=jsonobj.getString("requesstid");
//            String detaltablename=jsonobj.getString("eventid");
//            String mainkeyid=jsonobj.getString("mainkeyid");
//            JSONArray detailArray = jsonobj.getJSONArray("toDetail");
//            RecordSet rsdel = new RecordSet();
//            if("1".equals(del_Detail))
//            {
//                String delsql=" delete from  "+detaltablename+" where mainid='"+mainkeyid+"'";
//
//                rsdel.executeSql(delsql);
//            }
//
//            String mesg="";
//            String errormsg="";
...
//                    JSONObject tempobj = detailArray.getJSONObject(i);
//                    String insertsql = "  insert into " + detaltablename + " ( mainid " ;
//                    //   modefields + ",hashCode) values (" + modeid + ",1,";
//                    String modefields="";
//                    String insertvalue= "";
//                    if(tempobj!=null&&tempobj.size()>0) {
//                        //遍历key和value
//                        for (Object obj : tempobj.entrySet()) {
//                            Map.Entry<String, Object> entry = (Map.Entry<String, Object>) obj;
//                            // paramStr.add(entry.getKey() + "=" + entry.getValue());
//                            modefields += "," + entry.getKey();
//                            insertvalue += ",'" + entry.getValue() + "'";
//                        }
//
//                        insertsql += modefields + ") values (" + mainkeyid + insertvalue + ")";
//
//                        //this.writeDebuggerLog(className, "insertsql:[" + insertsql + "]");
//
//                        boolean zxzt=rsdel.execute(insertsql);
//                        if (!zxzt)
//                        {
//                            errormsg+=insertsql;
//                            // this.writeDebuggerLog(className, zxzt+"异常1sql:[" +insertsql+ "]");
//
//                            isok = false;
//                        }
//                        mesg += insertsql;
...
//                resultobj.put("msg", mesg);
//            }
//            else {
//                resultobj.put("code", "1");
//                resultobj.put("msg", "插入语句【"+errormsg +"】执行失败");
//            }
//            //  return resultobj;
//            this.writeDebuggerLog(className, "Request Status Code:[" + isok+ "],Interface Return Information:[" + resultobj + "]");
//
//        }catch(Exception ex){
//            ex.printStackTrace();
//            this.writeDebuggerLog(className, "异常1:[" + ex.getMessage() + "/" + ex.toString() + "]");
//        }
//        return resultobj;
//
//    }
