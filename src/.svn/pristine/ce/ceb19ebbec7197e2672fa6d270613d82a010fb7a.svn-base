...
//
//
//public class DocToPDFOnWatermark {
...
//     * @throws Exception
//     */
//    public int getOAdoc(int id, String username, String userpwd)
//            throws Exception {
//        int fjid = 0;
//
...
//        fjid = setOAdoc(file1, da.getFilename() + "", username,
//                userpwd);
//        file.delete();
//        file1.delete();
//        outputFile.delete();
...
//     * @throws Exception
//     */
//    public int setOAdoc(File dz, String name, String username, String userpwd)
//            throws Exception {
//
//        DocServiceImpl service = new DocServiceImpl();
//        User yhm = baseDao.getUserById(1);
