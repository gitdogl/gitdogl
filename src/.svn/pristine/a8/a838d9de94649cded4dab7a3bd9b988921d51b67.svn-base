 ...
 * 
 */
public class SPTestAction implements Action {
	/**
	 * 日志
	 */
	private static Logger logger = Logger
			.getLogger(SPTestAction.class);
	...
	public String execute(RequestInfo requestInfo) {
		...
		logger.error(requestInfo.getRequestid()+"失败测试");
		requestManager.setMessageid("70304");
		requestManager.setMessagecontent("失败测试");
