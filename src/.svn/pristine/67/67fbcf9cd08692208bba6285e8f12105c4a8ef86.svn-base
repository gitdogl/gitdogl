...
//        String wfovertimeDebug =Util.null2String(new BaseBean().getPropValue("workflowovertimeDebug","WORKFLOWOVERTIMEDEBUG"));
...
//                //writeLog(requestid+"|"+nodeid+"sql:"+sql);
...
//							}
//						}
//						//writeLog("超时processsecond："+processsecond+"====remindsecond:"+remindsecond+"===dateProcess:"+dateProcess+"===requestid:"+requestid);
//
...
//
//                                    //writeLog("超时提交至目标节点:requestid="+requestid+" flag:"+flag);
//                                    writeLog("超时提交至目标节点:requestid="+requestid);
//                            	}
//                            }else{//指定干预对象
//                                //log.debug("超时处理:流转至干预对象---begin");
//                                //writeLog("flowobjectids:"+flowobjectids);
...
//										writeLog("flowobjectlist=" + flowobjectlist);
...
//                            //判断人员状态
//                            int intStatus = Util.getIntValue(resource.getStatus(""+userid));
//                            if(intStatus!= 0 && intStatus!= 1 && intStatus!= 2 && intStatus!= 3){
//                                continue;
//                            }
...
//                            //判断人员状态
//                            int intStatus = Util.getIntValue(resource.getStatus(""+agentorbyagentid));
//                            if(intStatus!= 0 && intStatus!= 1 && intStatus!= 2 && intStatus!= 3){
//                                continue;
//                            }
//                            if(tempmail!=null && !tempmail.trim().equals("")){
...
//                    //判断人员状态
//                    int intStatus = Util.getIntValue(resource.getStatus(""+creater));
//                    if(intStatus!= 0 && intStatus!= 1 && intStatus!= 2 && intStatus!= 3){
//
//                    }else{
//                        if(tempmail!=null && !tempmail.trim().equals("")){
...
//                        //判断人员状态
//                        int intStatus = Util.getIntValue(resource.getStatus(""+managerid));
//                        if(intStatus!= 0 && intStatus!= 1 && intStatus!= 2 && intStatus!= 3){
//                            continue;
//                        }
//                        if(tempmail!=null && !tempmail.trim().equals("")){
...
//                    //判断人员状态
//                    int intStatus = Util.getIntValue(resource.getStatus(""+(String)remindobjectlist.get(i)));
//                    if(intStatus!= 0 && intStatus!= 1 && intStatus!= 2 && intStatus!= 3){
//                        continue;
//                    }
//                    if(tempmail!=null && !tempmail.trim().equals("")){
...
//        }
//
//        if(InfoCentreRemind==1){ // 信息中心提醒
//        	writeLog("InfoCentreRemind:"+InfoCentreRemind+"  CustomWorkflowid:"+CustomWorkflowid);
...
// 		writeLog("==========统一待办(WrokflowOverTimeTimer.java --> operateToDo)==========");
//    }
//
...
//        String isAutoRemark = "1";//允许处理节点自动提交
//        int istest = 0;
...
//        }
//        rs3.executeSql("select isbill,formid,isAutoApprove,isAutoCommit,isAutoRemark from workflow_base where id="+workflowid);
//        if(rs3.next()){
//            isbill=Util.getIntValue(rs3.getString("isbill"),0);
//            formid=Util.getIntValue(rs3.getString("formid"),0);
//            mailMessageType = rs3.getString("mailMessageType");
...
//            isAutoRemark = Util.null2s(rs3.getString("isAutoRemark"), "1");
//        }
...
//        //writeLog(passedgroups+"|"+totalgroups);
//        if(groupdetailids.equals("")){
//            //writeLog("aaaaaaaaaaa");
//            requestNodeFlow.setRequestid(requestid);
//            requestNodeFlow.setNodeid(nodeid);
//            requestNodeFlow.setNodetype(nodetype);
//            requestNodeFlow.setWorkflowid(workflowid);
...
//            //writeLog(hasnextnodeoperator);
//        }else{
//                //writeLog("bbbbbbbbbbbbb");
//                requestNodeFlow.setRequestid(requestid);
//                requestNodeFlow.setNodeid(nodeid);
//                requestNodeFlow.setNodetype(nodetype);
//                requestNodeFlow.setWorkflowid(workflowid);
...
//                //writeLog("nextnodeid:"+nextnodeid);
...
//                if (groupdetailids.equals("") && (nextnodeattr == 3 || nextnodeattr == 4 || nextnodeattr == 5)){
...
//                }
//                //writeLog(nodeid+"|"+nextnodeid+"|"+linkid+"|"+totalgroups);
...
//                rm.setIsAutoRemark(isAutoRemark);
...
//            writeLog("进入："+requestid+" nextnodeids.size:"+nextnodeids.size());
...
//        		    rst.commit();
//
//        		    writeLog("发送短信====================="+requestid);
//    			} catch (Exception e) {
//					rst.rollback();
//    				writeLog("发送短信====================="+e.getMessage());
//    				writeLog("超时短信提醒："+e);
//    			}
//
...
//
//				rst.commit();
//				writeLog("超时干预发送短信====================="+requestid);
//			} catch (Exception e) {
//				rst.rollback();
//				writeLog("超时干预发送短信====================="+e.getMessage());
//				writeLog("超时干预短信提醒："+e);
//			}
//     }
//
...
//                                        }
//                                        //writeLog("select userid,usertype,agentorbyagentid, agenttype from workflow_currentoperator where isremark in ('0','4') and requestid = " + requestid  + " order by showorder asc");
//                                        while(rs3.next()){
//											   // add by liaodong for qc80034 in 2013-11-06  start
//					                          if(!isCopyTo(rs3,operator89List)){
//												  if("0".equals(rs3.getString("usertype"))){
...
//
//            				rst.commit();
//            				writeLog("退回至目标节点提醒====================="+requestid);
//            			} catch (Exception e) {
//            				rst.rollback();
//            				writeLog("退回至目标节点提醒====================="+e.getMessage());
