...
import weaver.interfaces.jjc.oaclient.cw.dao.OAStatementsDao;
...
public class OAStatementsService {
    OAStatementsDao oaStatementsDao = new OAStatementsDao();
    K3StatementsService k3StatementsService = new K3StatementsService();

    public void exec(String billid) throws Exception {
        OAStatementsBill oaStatementsBill = oaStatementsDao.getOAStatementsBill(billid);
        List<OAStatementsDto2> oaStatementsDto2List = oaStatementsDao.getOAStatementsDto2List(oaStatementsBill.getId());
    ...
    public List<K3StatementsModelTRY> getK3StatementsModelTRYList(List<OAStatementsDto2> oaStatementsDto2List, OAStatementsBill oaStatementsBill) {
        ...
        if(oaStatementsDto2List.size()==0){
    ...
    public K3StatementsModel getK3StatementsModel(OAStatementsBill oaStatementsBill) {
        ...
        k3StatementsModel.setFREMARK(oaStatementsBill.getBz());
