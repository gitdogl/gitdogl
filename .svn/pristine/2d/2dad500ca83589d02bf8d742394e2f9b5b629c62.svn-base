...
public class K3PaymentNoteBill {
    ...
    K3PaymentNoteModel Model = new K3PaymentNoteModel();
    ...
    /**
     * 获取 @JSONField(ordinal = 10name = "Model")
     *
     * @return Model @JSONField(ordinal = 10name = "Model")
     */
    public K3PaymentNoteModel getModel() {
        return this.Model;
    }

    /**
     * 设置 @JSONField(ordinal = 10name = "Model")
     *
     * @param Model @JSONField(ordinal = 10name = "Model")
     */
    public void setModel(K3PaymentNoteModel Model) {
        this.Model = Model;
    }
}
